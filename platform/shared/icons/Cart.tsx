...
const Cart: React.FC<Props> = ({ width, height }) => (
  <svg width={width} height={height} viewBox={`0 0 ${height} ${width}`} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M14.56 5.307C14.3956 4.44901 13.9379 3.67488 13.2655 3.11719C12.593 2.5595 11.7476 2.25294 10.874 2.25V2.25C10.0037 2.25281 9.1613 2.55702 8.49002 3.1109C7.81873 3.66477 7.36006 4.43409 7.19202 5.288" stroke="#323645" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M20.624 0.75L18.374 3V5.25H20.624L22.874 3L20.624 0.75Z" stroke="#323645" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
)
